...
rect_h <- function(col, border = "light gray"){ # Horizontal
  ...
  legend(x = 0.8,y=0.8,legend = c(levels(raw.data$group)),fill = brewer.pal(9,"Set1")[1:n] )
}
...
if (directions=="transverse") {
  ...
  rect_h(brewer.pal(9,"Set1")[raw.data$group])
  ...
  rect_v(brewer.pal(9,"Set1")[rev(raw.data$group)])
}
dev.off()
