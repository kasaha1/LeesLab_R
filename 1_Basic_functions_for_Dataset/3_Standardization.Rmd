...
#-------------------------------------------------------------------
in.file <- "standardization_example.txt" # The first column name is "Symbol" which gonna be the key for merging
start.col <- 2 # the number of starting column for Numeric array data 
dir.in <- "C:/Users/kangs/Documents/Git_R/LeesLab_R/1_Basic_functions_for_Dataset/example_dataset"
...
# import data
raw.data <- read_delim(file.path(dir.in,in.file),delim = "\t")
...
in.file.name=unlist(strsplit(in.file,"\\.txt"))
