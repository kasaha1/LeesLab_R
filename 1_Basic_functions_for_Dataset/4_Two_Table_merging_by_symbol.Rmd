...
# The two files to be merged must have a column named *"Symbol"*.
...
in.file_1 <- file.choose() # The first column name is "Symbol" which gonna be the key for merging
print("Choose the file to be merged number 2")
in.file_2 <- file.choose() # The first column name is "Symbol" which gonna be the key for merging
