...
BCCPset_training_g$group_name <- BCCPset_training_g$sample
BCCPset_training_g$group_name[BCCPset_training_g$group == 1] <- paste0("S_",BCCPset_training_g$sample)
BCCPset_training_g$group_name[BCCPset_training_g$group == 2] <- paste0("z_",BCCPset_training_g$sample)
