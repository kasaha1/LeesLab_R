...
write_delim(x = testSet,path = file.path(dir.Out,"fitered_testset.txt"),delim = "\t")
...
dev.off()
write_delim(x = flitered_table,path = file.path(dir.Out,"table_supervisedClustering.txt"),delim = "\t")
