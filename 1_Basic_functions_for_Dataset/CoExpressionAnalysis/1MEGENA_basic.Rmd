...
#------------- Packages ----
packages <- c("ggplot2", "dplyr", "reshape2","moonBook", "readr","colorspace","MEGENA","Hmisc")
instPak (packages)
#-----------------------------
...
geneUniverse.table <- geneUniverse.table  %>% arrange(node.strength) %>% filter(row_number() < 51)
