...
![picture](figures/sacra_famiglia_canigiani.jpg)  
![palette](figures/palette.png)  



simply you can use like that :  
...
colours_vector <- palette_maker("C:/Users/kangs/Documents/Git_R/LeesLab_R/3_interesting_Code/figures/sacra_famiglia_canigiani.jpg", number_of_colors = numOfcolor) 
```
